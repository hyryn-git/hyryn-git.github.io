...
- **In-Memory Computing with Spintronic Devices**<br>Designing and benchmarking compute-in-memory architectures using magnetic tunnel junctions (MTJs) and other spintronic devices to overcome the memory wall in data-intensive applications.
